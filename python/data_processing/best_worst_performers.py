...
def bestWorstPerformers(account_id, settings):
    ...
    append_df_to_sql_table(best_performance, "best_performers", settings.createEngine())
    append_df_to_sql_table(worst_performance, "worst_performers", settings.createEngine())

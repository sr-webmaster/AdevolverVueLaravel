...
def populateAdGroupsAndAdGroupPerformance(account_id):
    ...
    deleteAndWriteToAdGroupsTable(adgroups, account_id, "adgroups", settings.createEngine())
    ...
    deleteAndWriteToAdGroupsTable(adgroup_performance, account_id, "adgroup_performance", settings.createEngine())

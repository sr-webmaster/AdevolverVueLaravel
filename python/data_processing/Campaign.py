...
def Campaign(account_id, settings):
    ...
    campaigns.to_sql("campaigns", settings.createEngine(), if_exists='append', index=False)
    ...
    campaign_performance.to_sql("campaign_performance", settings.createEngine(), if_exists='append', index=False)

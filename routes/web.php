...
Route::group(['middleware' => 'can:view,account'], function () {
  ...
  Route::get('/api/budget-commander/{account}', 'BudgetCommanderController@index');
  ...
  Route::get('/api/searchqueryperformance/{account}', 'SearchQueryPerformanceController@api');
